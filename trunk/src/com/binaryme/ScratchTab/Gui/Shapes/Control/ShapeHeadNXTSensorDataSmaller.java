...
public class ShapeHeadNXTSensorDataSmaller extends ShapeWithSlotsHead {

	public ShapeHeadNXTSensorDataSmaller(Activity context, Block<? extends Shape> associatedBlock) {
