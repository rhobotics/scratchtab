...
public class ShapeWaitUntilTrue extends ShapeWithSlotsSingleLevel {

	public ShapeWaitUntilTrue(Activity context, Block<? extends Shape> associatedBlock) {
	...
	protected void initLabels() {
		...
		//Widget 1 - Text
		label.appendContent( "Wait until" );
