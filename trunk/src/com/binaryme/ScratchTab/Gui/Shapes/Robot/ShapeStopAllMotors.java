...
public class ShapeStopAllMotors extends ShapeWithSlotsSingleLevel {

	public ShapeStopAllMotors(Activity context, Block<? extends Shape> associatedBlock) {
	...
	protected void initLabels() {
		...
		//Widget 1 - Text
		label.appendContent( "Stop all motors" );
