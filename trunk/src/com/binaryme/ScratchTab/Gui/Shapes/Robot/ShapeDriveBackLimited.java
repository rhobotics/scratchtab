...
public class ShapeDriveBackLimited extends ShapeWithSlotsSingleLevel {

	public ShapeDriveBackLimited(Activity context, Block<? extends Shape> associatedBlock) {
	...
	protected void initLabels() {
		...
		//Widget 1 - Text
		label.appendContent("Drive backward ");
