...
public class HeadNXTSensorDataLarger extends ExecutableDraggableBlockWithSlots<ShapeHeadNXTSensorDataLarger, Object> implements LegoNXTSensorEventListener, OnItemSelectedListener{  
	
	//pointer for the runnable
	private final HeadNXTSensorDataLarger thisObject = this;
	...
	public HeadNXTSensorDataLarger(Activity context, AttributeSet attrs,
			int defStyle) {
		...
		public HeadNXTSensorDataLarger(Activity context) {
			super(context);	
			init();
		}
		void init(){
...
//IMPLEMENT INTERFACES
		@Override
		protected ShapeHeadNXTSensorDataLarger initiateShapeHere() {
			return new ShapeHeadNXTSensorDataLarger(getContextActivity(),this);
		}
		@Override
		...
		public Slot getSuccessorSlot() {
			try{
				return this.getShape().getSlot(ShapeHeadNXTSensorDataLarger.CHILD_BELOW);
