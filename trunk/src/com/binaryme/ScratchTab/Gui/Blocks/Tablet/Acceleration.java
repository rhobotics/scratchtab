...
public class Acceleration extends AbstractSensorBlock<ShapeAcceleration> {

	public Acceleration(Activity context, AttributeSet attrs,
			int defStyle) {
	...
	public Acceleration(Activity context) {
		super(context);	
	}
	...
	@Override
	protected ShapeAcceleration initiateShapeHere() {
		return new ShapeAcceleration(getContextActivity(),this);
	}
	@Override
	protected MySensor getMySensorFromShape() {
		return ShapeAcceleration.sensor;
	}
