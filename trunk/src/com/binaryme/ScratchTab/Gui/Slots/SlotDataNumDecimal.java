...
import com.binaryme.ScratchTab.Gui.Blocks.Dummies.BlockSlotDummyDataDecimal;
...
public class SlotDataNumDecimal extends Slot<BlockSlotDummyDataDecimal,Double> {
	
	public SlotDataNumDecimal(Activity context) {
		super(context);
	}
	...
	@Override
	protected BlockSlotDummyDataDecimal initiateBlockSlotDummy() {
		return new BlockSlotDummyDataDecimal(getContextActivity(), new MNumDecimalField(getContextActivity()));
	}
