...
public class NXTCommFactory {
	...
	/*
	 * XXX hooking into the icommand here.
	 * Create a variable, which will save a, already connected, BluetoothSocket
	 * This BluetoothSocket will be used to create new instances of  NXTHandlers.
	 * 
	 * Don't forget setting the BluetoothSocket before using any icommand class. 
	 */
	...
	public static NXTComm createInstance() {
		...
		return new NXTCommBlueCove(socket);
...
//				
//				//TODO: don't use this class yet, the search method needs to be reimplemented
//				//TODO delete
//				NXTInfo[] nxts = null;
//				//TODO uncomment
