...
public class Divide extends ExecutableDraggableBlockWithSlots<ShapeDivide, Double> {
	public Divide(Activity context, AttributeSet attrs,
			int defStyle) {
		...
		public Divide(Activity context) {
			super(context);	
		}
		@Override
		...
		@Override
		protected ShapeDivide initiateShapeHere() {
			return new ShapeDivide(getContextActivity(), this);
		}
