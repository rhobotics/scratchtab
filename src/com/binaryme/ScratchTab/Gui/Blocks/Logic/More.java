...
import com.binaryme.ScratchTab.Gui.Shapes.Logic.ShapeMore;
...
public class More extends ExecutableDraggableBlockWithSlots<ShapeMore, Boolean> {
	
	SlotDataNumDecimal slotDataNumDecimalLeft;
	SlotDataNumDecimal slotDataNumDecimalRight;
	
	public More(Activity context, AttributeSet attrs,
			int defStyle) {
		...
		@Override
		protected ShapeMore initiateShapeHere() {
			return new ShapeMore(getContextActivity(), this);
		}
}
