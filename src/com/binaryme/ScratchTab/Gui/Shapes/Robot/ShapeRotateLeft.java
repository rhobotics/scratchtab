...
public class ShapeRotateLeft extends ShapeWithSlotsSingleLevel {

	public ShapeRotateLeft(Activity context, Block<? extends Shape> associatedBlock) {
	...
	protected void initLabels() {
		...
		//Widget 1 - Text
		label.appendContent( "Rotate left forever" );
