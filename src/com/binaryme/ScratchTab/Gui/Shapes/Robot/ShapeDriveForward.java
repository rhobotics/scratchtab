...
public class ShapeDriveForward extends ShapeWithSlotsSingleLevel {

	public ShapeDriveForward(Activity context, Block<? extends Shape> associatedBlock) {
	...
	protected void initLabels() {
		...
		//Widget 1 - Text
		label.appendContent( "Drive forward" );
