...
public class ShapeTurnRight extends ShapeWithSlotsSingleLevel {

	public ShapeTurnRight(Activity context, Block<? extends Shape> associatedBlock) {
	...
	protected void initLabels() {
		...
		//Widget 1 - Text
		label.appendContent( "Turn right" );
